        ...
        function c() {
          ...
          for (; t;) {
            ...
            if (s) {
              const [e, i] = s
              ;
              if (S.addText(n), n = "", l[r] = (l[r] || 0) + 1, l[r] <= 7 && (R += i), e.startsWith("_")) n += t[0];
              else {
      ...
      m = function (b) {
        ...
        return {
          ...
          contains: [b.SHEBANG({
            ...
            returnBegin: !0,
            label: "func.def",
            contains: [S, b.inherit(b.TITLE_MODE, {
              begin: d,
              className: "title.function"
            })]
          }, {
...
hljs.registerLanguage("r", (() => {
  ...
  return n => {
    const a = /(?:(?:[a-zA-Z]|\.[._a-zA-Z])[._a-zA-Z0-9]*)|\.(?!\d)/,
      i = e(/0[xX][0-9a-fA-F]+\.[0-9a-fA-F]*[pP][+-]?\d+i?/, /0[xX][0-9a-fA-F]+(?:[pP][+-]?\d+)?[Li]?/, /(?:\d+(?:\.\d*)?|\.\d+)(?:[eE][+-]?\d+)?[Li]?/),
      s = /[=!<>:]=|\|\||&&|:::?|<-|<<-|->>|->|\|>|[-+*\/?!$&|:<=>@^~]|\*\*/,
      t = e(/[()]/, /[{}]/, /\[\[/, /[[\]]/, /\\/, /,/);
    return {
      name: "R",
  ...
  return b => {
    ...
    return {
      ...
      contains: [b.SHEBANG({
        ...
        returnBegin: !0,
        label: "func.def",
        contains: [w, b.inherit(b.TITLE_MODE, {
          begin: g,
          className: "title.function"
        })]
      }, {
