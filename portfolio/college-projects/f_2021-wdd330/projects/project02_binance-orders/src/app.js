...
import Minichart, {
	changeTimeframe
} from './lib/minichart.mjs';

// import { getUserDataStream } from './lib/getUserDataStream.js';
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> User Data Stream
/** Read:
	* https: //developers.binance.com/docs/binance-api/spot-detail/user-data-stream#create-a-listenkey
	*/

async function getListenKey() {

	// const apiKey = priv.BINANCE_APIKEY;
	// const apiKey = pub.TESTNET_APIKEY;
	const apiKey = 'v81wokV9ts8JqgnOE8sPmIBdh9TsQhSSNMFmHnjLxg85J7GXEGTiMINlCHF1Z7rR'; // Testnet
...
let listenKey12 = await getListenKey();
console.log(listenKey12);

/** WebSocket Endpoint
 * wss://stream.binance.com:9443/ws/<listenKey>
 * wss://stream.binance.com:9443/stream?streams=<listenKey>
 * Valid for 24hs
 **/
